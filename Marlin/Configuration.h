...
//#define MAKERARM_SCARA
...
#if ENABLED(MORGAN_SCARA) || ENABLED(MAKERARM_SCARA) || ENABLED(ALEX_SCARA)
  ...
  #define SCARA_HOME_X (SCARA_LINKAGE_1 + SCARA_LINKAGE_2)
  #define SCARA_HOME_Y 0
  #define SERVO_INITIAL 60.0
  #define SERVO_LEVEL_FACTOR 2.1645
...
#define STRING_CONFIG_H_AUTHOR "(Alex, scara config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SR_PLOTS_A_LOT"
 ...
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 94.79, 88.89, 4000, 500 }  // 16 micro steps
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 189.63, 177.78, 4000, 500 } // 32 micro steps
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {  10,  10, 100, 10000 }
